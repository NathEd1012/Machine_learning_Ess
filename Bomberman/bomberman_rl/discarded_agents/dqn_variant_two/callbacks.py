...
def setup(self):
    ...
    # Input-output sizes
    input_size = 13 # 4: neighboring_tiles_features, 5: bomb_features, 1: next_move_coin_features, 
    # 1: next_move_crate_features, 1: how_many_crates_boom, 1: next_move_safe_tile_features
